...
${truncated}`
  ...
  try {
    ...
    tender.pdfAnalysis = {
      ...
      relevanceFit: (analysis.relevanceFit || analysis.evrimFit) ? String(analysis.relevanceFit || analysis.evrimFit).slice(0, 200) : null,
    ...
    const fitText = analysis.relevanceFit || analysis.evrimFit;
    if (fitText) {
